...
*Что такое флуд?* — это объёмное сообщение, не несущие смысловой нагрузки.  
...
*Рекомендуемая мера наказания: от пермаментного мут до пермаментного бана* + Варн навсегда
+ В варне указывайте: **«Чтобы снять мут — подайте апелляцию в тикете»**.
Если человек продолжает разглашать личную информацию какими-либо способами (Участникам сервера в ЛС) - выдайте пермаментный бан и сообщите об этом в стафф-чате + скриншоты нарушения в стафф-чате
